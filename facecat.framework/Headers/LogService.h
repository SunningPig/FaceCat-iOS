...
namespace FaceCat
{
    ...
    */
    ...
    private:
        ...
        * 所有的日志类型服务
        */
        std::map<int, BaseAppender*> m_appenders;
        /*
        * 数据信息
        */
        std::map<int, std::vector<LogWorkDataInfo*>*> m_dataInfos;
        /*
        * 锁
        */
        FCLock m_lock;
        ...
        * 消息列表
        */
        std::vector<LogWorkDataInfo*> m_messages;
        /*
        * 退出事件
        */
        ...
        * 停止事件
        */
        std::vector<LogReqDataInfo> m_stopPushDatas;
        /*
        * 计数器
        */
        int m_tick;
    ...
    private:
        ...
        */
        void startWork(std::vector<LogWorkDataInfo*> &dataInfos);
    public:
        /*
        * 构造函数
        */
