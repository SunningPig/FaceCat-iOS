...
namespace FaceCat{
    ...
    * 预键盘事件
    */
    class FCPreviewsKeyEventCallBack {
    public:
    ...
    * 控件预触摸事件
    */
    class FCPreviewsTouchEventCallBack {
    public:
    ...
    */
     ...
     * 控件的基类
     */
    class FCView : public FCAttribute{
    public:
        FCAtrEx *m_atrEx;
        /**
         * 横向排列方式
